	...
	<view v-if="!loadding" :data-theme='theme()' :class="theme() || ''">
		<view v-if="listData.length>0" class="pbenv">
			<view class="address-list">
				<view class="address p-30-0 bg-white" v-for="(item,index) in listData" :key="index">
					...
					<view class="d-b-c">
						...
						<view class="d-e-c">
							<view class="icon-box plus d-e-c ml30" @click="delAddress(item.address_id)">
							...
							<view class="icon-box plus d-e-c ml30 mr40" @click="editAddress(item.address_id)">
