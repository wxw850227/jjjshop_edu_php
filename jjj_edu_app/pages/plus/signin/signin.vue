<template>
	<view :data-theme='theme()' :class="theme() || ''" class="signin-container" v-if="!loading">
		<view class="pr signin-top">
			<image class="bg-signin" src="/static/address/signinBg.png" mode=""></image>
			...
			<view class="signin-click1">
				<image class="signin-circle" src="/static/address/signinCircle.png" mode=""></image>
			...
			<view class="signinDay">已经累计签到<text class="p-0-10 text2 fb" style="color: #EBBF4C">{{ days }}</text>天</view>
		</view>
