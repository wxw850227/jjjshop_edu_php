<template>
  ...
  <div v-loading="loading">
    <!--添加商城-->
    <div class="common-level-rail"><el-button type="primary" @click="addClick">添加平台</el-button></div>
    <!--内容-->
          ...
          <el-table size="small" :data="tableData" style="width: 100%;" row-key="access_id" border default-expand-all v-loading="loading">
            ...
            <el-table-column prop="is_recycle" label="状态">
              <template  #default="scope">
                <el-checkbox v-model="scope.row.is_recycle" @change="checked => statusChange(checked, scope.row)">启用</el-checkbox>
              </template>
            </el-table-column>
            <el-table-column prop="weixin_service" label="微信服务商支付">
              <template  #default="scope">
                <el-checkbox v-model="scope.row.weixin_service" @change="checked => wxStatusChange(checked, scope.row)">启用</el-checkbox>
              </template>
            </el-table-column>
            ...
            <el-table-column label="操作" width="150">
              <template  #default="scope">
               <el-link :href="targetLinkAddress()" target="_blank" type="primary" size="small">进入平台</el-link>
