  ...
  <el-dialog title="编辑平台" v-model="dialogVisible" @close='dialogFormVisible' :close-on-click-modal="false"
    ...
    <el-form size="small" :model="form" ref="form" :rules="rules">
      ...
      <el-form-item label="过期时间" :label-width="formLabelWidth" prop="expire_time">
        <el-date-picker v-model="form.expire_time_text" type="date" placeholder="过期时间" value-format="YYYY-MM-DD" :disabled="form.no_expire"></el-date-picker>
      ...
      <el-form-item label="平台账户名" :label-width="formLabelWidth" prop="user_name">
        ...
        <el-col class="gray">注：平台后台用户名</el-col>
      </el-form-item>
      <el-form-item label="平台账户密码" :label-width="formLabelWidth" prop="password">
        ...
        <el-col class="gray">注：平台后台用户密码</el-col>
      </el-form-item>
