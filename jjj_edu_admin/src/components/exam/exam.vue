<template>
	<!--
    	描述：组件-选择真题
    -->
	<el-dialog title="选择真题" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
		:close-on-press-escape="false" width="900px">
		<div class="common-seach-wrap">
			<el-form :inline="true" size="small" :model="formInline" class="demo-form-inline">
				<el-form-item label="真题分类">
					<el-select v-model="formInline.category_id" placeholder="请选择真题分类">
				...
				<el-form-item label="真题名称">
					<el-input placeholder="请输入真题名称" v-model="formInline.search">
					</el-input>
				</el-form-item>
				<el-form-item label="">
...
<script>
	...
	export default {
		...
		props: ['isExam', 'excludeIds', 'islist'],
		watch: {
			isExam: function(n, o) {
				if (n != o) {
					if (n) {
