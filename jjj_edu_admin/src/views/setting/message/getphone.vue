  ...
  <div class="pt30">
    ...
    <el-form size="small" ref="form" :model="form" label-width="200px">
      <el-form-item label="获取手机号">
        <el-checkbox-group v-model="form.area_type">
    ...
    methods: {
      ...
      getParams() {
        ...
        SettingApi.getPhoneDetail({}, true).then(res => {
            ...
            self.form.area_type = vars.area_type;
            // 转成整数，兼容组件
            for(let i=0;i<self.form.area_type.length;i++){
              self.form.area_type[i] = parseInt(self.form.area_type[i]);
            }
