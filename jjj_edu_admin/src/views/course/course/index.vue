  ...
  <div class="product-list">
    ...
    <div class="common-seach-wrap">
      <el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
        ...
        <el-form-item label="课程名称"><el-input size="small" v-model="searchForm.search" placeholder="请输入课程名称"></el-input></el-form-item>
        <el-form-item><el-button size="small" type="primary" icon="Search" @click="onSubmit">查询</el-button></el-form-item>
      </el-form>
    </div>
    <!--添加课程-->
    <div class="common-level-rail"><el-button size="small" type="primary" icon="Plus" @click="addClick" v-auth="'/course/course/add'">添加课程</el-button></div>
    <!--内容-->
      ...
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="image" label="课程封面">
            <template  #default="scope">
              <div class="product-info">
                <div class="pic"><img v-img-url="scope.row.image && scope.row.image.file_path" alt="" /></div>
              </div>
            </template>
          </el-table-column>
          ...
          <el-table-column fixed="right" label="操作" width="150">
            <template  #default="scope">
              <el-button @click="editClick(scope.row)" type="text" size="small" v-auth="'/course/course/edit'">编辑</el-button>
              <el-button @click="sectionClick(scope.row)" type="text" size="small">详情</el-button>
              <el-button @click="delClick(scope.row)" type="text" size="small" v-auth="'/course/course/delete'">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
